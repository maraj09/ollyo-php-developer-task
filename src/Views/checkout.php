...
<body>
  <div class="max-w-[1200px] mx-auto my-20">
    ...
    <form method="post" action="<?php echo BASE_URL . '/checkout' ?>" class="space-y-8">
  ...
  <script src="https://www.paypal.com/sdk/js?client-id=AUckGZtkosYVlphrelqn_LysMjKMkC_ff7YQowVBNgszRx4Fcv2bIw4PAYipY34A3BTH5GczNOOXKfKC"></script>
  <script>
    paypal.Buttons({
